...
async def on_message(message):
    if message.content.startswith('/status'):
            ...
            embed = discord.Embed(title="#name-dropping-alert", description="The name `Lama` is dropping and has received no queries on our availability checker!", colour=0x1a94f0)
